 ...
 */
final class Version20200504144102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD main_picture_id INT DEFAULT NULL, ADD slug VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP main_picture_id, DROP slug');
    }
}
